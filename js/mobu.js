...
const dom =(url='assets/img/picture.jpg',dom)=>{

    let doms = 
` <div class="htmleaf-container ">

<!-- Content -->
<div class="container containerMM ">
    <span class="glyphicon glyphicon-off closes close" aria-hidden="true"></span>
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="modal fade docs-cropped" id="getCroppedCanvasModal" aria-hidden="true" aria-labelledby="getCroppedCanvasTitle" role="dialog" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <a href="javascript:;"> <span class="glyphicon glyphicon-open"></span></a>
    ...
    Set Crop Box Data
        ...
        <div class="col-md-3 docs-toggles">
            ...
            <div class="btn-group btn-group-justified" data-toggle="buttons">
                <label class="btn btn-primary active" data-method="setAspectRatio" data-option="${dom.bl}" title="Set Aspect Ratio">
    <input class="sr-only" id="aspestRatio1" name="aspestRatio" value="${dom.bl}" type="radio">
    <span class="docs-tooltip" data-toggle="tooltip" title="$().cropper(&quot;setAspectRatio&quot;, ${dom.width} / ${dom.height})">
     flex
    </span>
  </label>
